/*
Tested 2025-02-04, not working ☹️.  Result: dialog box without artboards.

SOURCE: https://graphicdesign.stackexchange.com/questions/3619/can-you-re-number-the-order-of-artboards-in-illustrator-cs4
*/


// var script.name = reArrangeArtboards_v2.jsx;
// var script.description = reArranges the Artboards indexes;
// var script.requirement = an open document with at least 2 artboards, CS4 & Up;
// var script.tip = click on the Artboard tool, before running, to see the AB Indexes
//  var script.parent = CarlosCanto; // 12/24/12
